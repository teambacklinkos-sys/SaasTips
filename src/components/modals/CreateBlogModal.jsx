...
export default function CreateBlogModal({ onClose, onCreate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      await onCreate({ ...formData, createdAt: new Date().toISOString() });
    } catch (error) {
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[92vh] flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-0.5">Fill in the details below to publish</p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="overflow-y-auto flex-1 px-6 py-5 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. 10 SaaS Growth Strategies for 2025"
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="A brief summary shown in blog cards and previews..."
              rows="2"
        ...
        <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between gap-3 bg-slate-50 rounded-b-2xl">
          ...
          <div className="flex gap-3">
            ...
            >
              {isLoading ? <><Loader2 size={15} className="animate-spin" /> Publishing...</> : 'Publish Post'}
            </button>
          </div>
        </div>
      </div>
